  ...
  <div class="master">
    <div class="container">
      <div class="search__wrap">
        ...
        <h4 class="title">{{ $store.state.translations["main.search-members"] }}</h4>

        <div @click="$router.push(localePath('members'))" class="search">
          ...
          <input type="text" id="search" :placeholder="$store.state.translations['main.search-members']" />
      ...
      <HomeEvents :community="community" />
    ...
    <div style="margin-top: -50px;" class="sponsor">
      <div class="imgs">
