  ...
  <div class="master">
    ...
    <div class="container">
      <div class="search__wrap">
        <div class="search">
          ...
          <input type="text" id="search" v-model="search" @input="onSearch"
            :placeholder="$store.state.translations['main.search-community']" />
      ...
      <div class="categories">
        <ul>
          <button v-if="categories.slice(0, -3).length > 0" @click="visible = true">+{{ categories.slice(0, -3).length
            }}</button>
    ...
    <div class="container">
      ...
      <div class="pag-block">
        <VPagination :load="true" class="xl:hidden" :totalPage="totalPage" @getData="__GET_COMMUNITIES" />
      </div>
